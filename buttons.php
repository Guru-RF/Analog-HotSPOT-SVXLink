...
<?php
 ...
 if(array_key_exists('button11', $_POST)) {
	shell_exec('/usr/sbin/hotspot_dtmf ' . KEY11[1]);
            echo "<meta http-equiv='refresh' content='0'>";
        }
 if(array_key_exists('button12', $_POST)) {
	shell_exec('/usr/sbin/hotspot_dtmf ' . KEY12[1]);
            echo "<meta http-equiv='refresh' content='0'>";
        }
 if(array_key_exists('button13', $_POST)) {
	shell_exec('/usr/sbin/hotspot_dtmf ' . KEY13[1]);
            echo "<meta http-equiv='refresh' content='0'>";
        }
 if(array_key_exists('button14', $_POST)) {
	shell_exec('/usr/sbin/hotspot_dtmf ' . KEY14[1]);
            echo "<meta http-equiv='refresh' content='0'>";
        }
 if(array_key_exists('button15', $_POST)) {
	shell_exec('/usr/sbin/hotspot_dtmf ' . KEY15[1]);
            echo "<meta http-equiv='refresh' content='0'>";
        }
 if(array_key_exists('button16', $_POST)) {
	shell_exec('/usr/sbin/hotspot_dtmf ' . KEY16[1]);
            echo "<meta http-equiv='refresh' content='0'>";
        }
 if(array_key_exists('button17', $_POST)) {
	shell_exec('/usr/sbin/hotspot_dtmf ' . KEY17[1]);
            echo "<meta http-equiv='refresh' content='0'>";
        }
 if(array_key_exists('button18', $_POST)) {
	shell_exec('/usr/sbin/hotspot_dtmf ' . KEY18[1]);
            echo "<meta http-equiv='refresh' content='0'>";
        }
 if(array_key_exists('button19', $_POST)) {
	shell_exec('/usr/sbin/hotspot_dtmf ' . KEY19[1]);
            echo "<meta http-equiv='refresh' content='0'>";
        }
 if(array_key_exists('button20', $_POST)) {
	shell_exec('/usr/sbin/hotspot_dtmf ' . KEY20[1]);
            echo "<meta http-equiv='refresh' content='0'>";
        }
?> 
...
<form method="post">
	...
	<input type="submit" name="button20"
            class=<?php echo KEY20[2] ?> value='<?php echo KEY20[0] ?>' />
